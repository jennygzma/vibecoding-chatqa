const STORAGE_KEY = 'startupsimulator-annotation-review-v1';
...
function exportReview() {
  ...
  download('startupsimulator-annotation-review.json', {
    format: 'startupsimulator-annotation-review-v1',
...
function registerWebMCP() {
  ...
  register({
    ...
    description: 'Return counts for reviewed and unreviewed StartupSimulator annotation candidates.',
  ...
  register({
    ...
    description: 'Approve, reject, or flag one visible StartupSimulator annotation candidate for editing.',
    inputSchema: {
      type: 'object',
      properties: {
        itemId: { type: 'string' },
